...
function create() {
    ...
    this.physics.add.overlap(this.alitu, this.obstacles, alituHitObstacle, null, this);
...
this.obstacles.children.iterate((child) => {
    if (Phaser.Geom.Intersects.RectangleToRectangle(this.alitu.getBounds(), child.getBounds())) {
        alituHitObstacle.call(this);
    }
});
